        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyndicateIdCardPath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CertificatePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    City = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ClinicAddress = table.Column<string>(type: "TEXT", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChronicDiseases = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PatientMedicalProfileId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalAttachments_PatientMedicalProfiles_PatientMedicalProfileId",
                        column: x => x.PatientMedicalProfileId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prescription = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalRecords_PatientMedicalProfiles_PatientMedicalProfileId",
                        column: x => x.PatientMedicalProfileId,
                        principalTable: "PatientMedicalProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalAttachments_PatientMedicalProfileId",
                table: "MedicalAttachments",
                column: "PatientMedicalProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecords_PatientMedicalProfileId",
                table: "MedicalRecords",
                column: "PatientMedicalProfileId");
